...
/* let loguito = document.getElementById("logo")

loguito.addEventListener("mouseover",()=>{

    console.log("por encima del logo")
...
let presion = document.getElementById("boton")

presion.onkeyup = function(event) {
    console.log("Usted está presionando la tecla "+ event.key)
}
